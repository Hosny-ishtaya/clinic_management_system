 ...
 * @author Hosny
 */
public class PatientdeController implements Initializable {
    ...
    @FXML
    void add_patientt(ActionEvent event) {
         System.out.println("add patienttttttttt");
         try { 
      ...
      String str_stmt =" insert into patient values('"+FN+"','"+LN+"','"+Birth+"','"+Address+"',"+Pho+","+id+",'"+ss+"','"+CN+"','"+ND+"','"+Gen+"')";
